...
sys.path.insert(0, os.path.abspath('../../MLpred'))
...
htmlhelp_basename = 'geoscf-localdoc'
...
latex_documents = [
    (master_doc, 'geos-cf-local.tex', u'geos-cf local Documentation',
     u'Christoph Andrea Keller, Junhua Liu, Noussair Lazrak', 'manual'),
]
